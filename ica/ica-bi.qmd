...
```{r}
ggplot(elections, aes(x=repub_pct_20)) + geom_density()
```
...
This is a strong correlation because the values betweeeen the republican percentages won in 2016 and 2020 are very similar, indicating a strong relationship. The main outlier is texas as it seems to be deviating from the trend 
...
```
Median rent is a better predictor of repub pct 20 than median age
...
historically, counties tend to lean more republican than purple or democrat
...
-   Which do you like best? violin plots
-   What is one pro of density plots relative to boxplots? helps us vizualize the plots better
-   What is one con of density plots relative to boxplots? we can see each plot induvidually
...
helps everything be proportional to vizualize
#### Part b {.unnumbered}
